  ...
  return (
    <div>
      ...
      <form onSubmit={savePlace}>
        ...
        {preInput('Name', 'Name of the owner of this place')}
        <input required type="text" value={name} onChange={ev => setName(ev.target.value)} placeholder="name"/>
        ...
        <div className="grid gap-2 grid-cols-2 md:grid-cols-4">
          ...
          <div>
            ...
            <input required min={1} type="number" value={maxGuests}
                   onChange={ev => setMaxGuests(ev.target.value)}/>
          </div>
          <div>
            <h3 className="mt-2 -mb-1">Price per night</h3>
            <input required min={1} type="number" value={price}
